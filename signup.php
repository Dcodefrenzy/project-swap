...
<body>
    ...
    <form action="" method="">
       ...
       <p>Date Of Birth:<input type="date" /></p>
        <p>Adress: <br /><textarea rows="10" cols="20"> </textarea></p>
         <p>Phone Number:<input type="text" /></p>
         <p>Email:<input type="email" /></p>
         <p>Sex: Male <input type="radio" name="sex"/>
         		 Female <input type="radio" name="sex"/></p>
         <p>Nationality:<select>
         					<option>Select Nationality</option>
                            <option>Alstrailia</option>
            ...
            <select name="state-of-origin" id="select">
                <option>---Select State---</option>
                <option>ABUJA FCT</option>
                <option>ABIA</option><option>ADAMAWA</option>
